...
function page() {
  ...
  useEffect(() => {
    ...
    gsap.to(imageRef.current, {
      width: '100vw',
      height: '100vh', // Adjust final height as needed
      scrollTrigger: {
  ...
  return (
    <>
      <div className='body w-full h-[100vh] relative'>
        <div ref={containerRef} className="absolute flex items-center justify-center top-[100%] left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[inherit] h-[15rem]">
          <img ref={imageRef} className="w-1/2 h-1/2 object-cover" src="https://images.unsplash.com/photo-1506744038136-46273834b3fb" alt="" />
        </div>
      </div>
